package com.arisveam.planit.utils;
...
import com.arisveam.planit.AssignmentViewer;
import com.arisveam.planit.R;
import com.arisveam.planit.data.Assignment;

import java.text.SimpleDateFormat;
import java.util.ArrayList;

public class ShowcaseAssignmentHolder extends ArrayAdapter<Assignment> {

    SimpleDateFormat assignmentFormatter = new SimpleDateFormat("MMMM d, yyyy", java.util.Locale.getDefault());

    public ShowcaseAssignmentHolder(Context context, ArrayList<Assignment> assignments) {
