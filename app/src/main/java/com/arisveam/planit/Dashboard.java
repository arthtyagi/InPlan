...
import com.arisveam.planit.data.Assignment;
import com.arisveam.planit.data.Time;
import com.arisveam.planit.showcase.ShowcaseActivity;
import com.arisveam.planit.utils.AlarmReceiver;
import com.arisveam.planit.utils.Database;
...
public class Dashboard extends AppCompatActivity
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, Void> {
        ...
        private void getDataFromApi() throws IOException {
            ...
            ArrayList<com.arisveam.planit.data.Course> classroomCourses = new ArrayList<>();
            ...
            for (com.arisveam.planit.data.Course course : Database.getCourses()) {
            ...
            for (Course course : courseResponse.getCourses()) {
                ...
                if (course.getCourseState().equals("ACTIVE")) {
                    com.arisveam.planit.data.Course dbCourse = new com.arisveam.planit.data.Course(
                            course.getName(),
                    ...
                    if (!courseIDs.contains(course.getId())) {
                        ...
                        for (com.arisveam.planit.data.Course mCourse : classroomCourses) {
